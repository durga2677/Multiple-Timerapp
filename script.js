// in this code to get the 'activeTimers' element in the HTML
const activeTimers = document.getElementById('activeTimers');
// Display the initial "You have no timers currently!" text
displayNoTimersText();

// in this code to get the 'startTimer' button in the HTML
...
//  in this Function to remove "You have no timers currently!" text
